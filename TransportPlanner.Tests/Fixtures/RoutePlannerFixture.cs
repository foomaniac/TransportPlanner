   ...
   public class RoutePlannerFixture
    {
        ...
        private void SeedJourneys()
        {
            ...
            //Buenos Aires > Casablanca > Liverpool
             _context.Journeys.Add(new Journey((int)NetworkIds.BuenosAiresCasablancaLiverpool, 0, (int)RouteIds.BuenosAiresToCasablanca));
             _context.Journeys.Add(new Journey((int)NetworkIds.BuenosAiresCasablancaLiverpool, 1, (int)RouteIds.CasablancaToLiverpool));

            //Route Network 1 - 16 Days
            //Buenos Aires > Cape Town > New York > Liverpool
             _context.Journeys.Add(new Journey((int)NetworkIds.BuenosAiresCapeTownNewYorkLiverpool, 0, (int)RouteIds.BuenosAiresToCapeTown));
             _context.Journeys.Add(new Journey((int)NetworkIds.BuenosAiresCapeTownNewYorkLiverpool, 1, (int)RouteIds.CapeTownToNewYork));
             _context.Journeys.Add(new Journey((int)NetworkIds.BuenosAiresCapeTownNewYorkLiverpool, 2, (int)RouteIds.NewYorkToLiverpool));

            //Route Network 2 - 10 Days
            //Buenos Aires > New York > Liverpool 
             _context.Journeys.Add(new Journey((int)NetworkIds.BuenosAiresNewYorkLiverpool, 0, (int)RouteIds.BuenosAiresToNewYork));
             _context.Journeys.Add(new Journey((int)NetworkIds.BuenosAiresNewYorkLiverpool, 1, (int)RouteIds.NewYorkToLiverpool));

            //Route Network 3 - 18 Days
            //New York > Liverpool > Cape Town > New York
             _context.Journeys.Add(new Journey((int)NetworkIds.NewYorkLiverpoolCapeTownNewYork, 0, (int)RouteIds.NewYorkToLiverpool));
             _context.Journeys.Add(new Journey((int)NetworkIds.NewYorkLiverpoolCapeTownNewYork, 1, (int)RouteIds.LiverpoolToCapeTown));
             _context.Journeys.Add(new Journey((int)NetworkIds.NewYorkLiverpoolCapeTownNewYork, 2, (int)RouteIds.CapeTownToNewYork));
            ...
            //Buesno Aires > Casablanca - 5 Days
             _context.Journeys.Add(new Journey((int)NetworkIds.BuenosAiresCasablanca, 0, (int)RouteIds.BuenosAiresToCasablanca));


            //Route Network 5 
            //Liverpool > Cape Town > NewYork > Liverpool
             _context.Journeys.Add(new Journey((int)NetworkIds.LiverpoolCapeTownNewyorkLiverpool, 0, (int)RouteIds.LiverpoolToCapeTown));
             _context.Journeys.Add(new Journey((int)NetworkIds.LiverpoolCapeTownNewyorkLiverpool, 1, (int)RouteIds.CapeTownToNewYork));
             _context.Journeys.Add(new Journey((int)NetworkIds.LiverpoolCapeTownNewyorkLiverpool, 2, (int)RouteIds.NewYorkToLiverpool));

            //Route Network 5 
            //Liverpool > Casablanc > Liverpool
             _context.Journeys.Add(new Journey((int)NetworkIds.LiverpoolCasablancaLiverpool, 0, (int)RouteIds.LiverpoolToCasablanca));
             _context.Journeys.Add(new Journey((int)NetworkIds.LiverpoolCasablancaLiverpool, 1, (int)RouteIds.CasablancaToLiverpool));


            //Route Network 6
            //New York > Liverpool > Casablanca > Liverpool > Cape Town > New York
             _context.Journeys.Add(new Journey((int)NetworkIds.NewYorkLiverpoolCasablancaLiverpoolCapeTownNewYork, 0, (int)RouteIds.NewYorkToLiverpool));
             _context.Journeys.Add(new Journey((int)NetworkIds.NewYorkLiverpoolCasablancaLiverpoolCapeTownNewYork, 1, (int)RouteIds.LiverpoolToCasablanca));
             _context.Journeys.Add(new Journey((int)NetworkIds.NewYorkLiverpoolCasablancaLiverpoolCapeTownNewYork, 2, (int)RouteIds.CasablancaToLiverpool));
             _context.Journeys.Add(new Journey((int)NetworkIds.NewYorkLiverpoolCasablancaLiverpoolCapeTownNewYork, 3, (int)RouteIds.LiverpoolToCapeTown));
             _context.Journeys.Add(new Journey((int)NetworkIds.NewYorkLiverpoolCasablancaLiverpoolCapeTownNewYork, 4, (int)RouteIds.CapeTownToNewYork));
